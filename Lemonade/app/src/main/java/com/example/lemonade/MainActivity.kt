...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                strResource = R.string.lemon_select
                imgResource = R.drawable.lemon_tree
            }
            SQUEEZE -> {
                strResource = R.string.lemon_squeeze
                imgResource = R.drawable.lemon_squeeze
            }
            DRINK -> {
                strResource = R.string.lemon_drink
                imgResource = R.drawable.lemon_drink
            }
            RESTART -> {
                strResource = R.string.lemon_empty_glass
                imgResource = R.drawable.lemon_restart
            }
        }
        textAction.text = getString(strResource)
        lemonImage!!.setImageResource(imgResource)
